/* Source and licensing information for the line(s) below can be found at https://www.pfizer.com/modules/pfizer/pfizer_corporate_base/modules/pfizer_corporate_block_types/pfizer_corporate_interactive_maps/js/interactive_maps.min.js. */
(function(e){"use strict";Drupal.behaviors.interactive_map={attach:function(t,a){e(".tab-content").once().click(function(){e(".tabs-default").once().hide();e(".active-tab").removeClass("active-tab");e("."+e(this).attr("id")).addClass("active-tab")})}}})(jQuery);
/* Source and licensing information for the above line(s) can be found at https://www.pfizer.com/modules/pfizer/pfizer_corporate_base/modules/pfizer_corporate_block_types/pfizer_corporate_interactive_maps/js/interactive_maps.min.js. */;
