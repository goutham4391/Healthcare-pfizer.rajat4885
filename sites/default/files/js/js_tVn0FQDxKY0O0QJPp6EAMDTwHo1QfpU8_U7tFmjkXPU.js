...
/* Source and licensing information for the line(s) below can be found at https://www.pfizer.com/modules/pfizer/pfizer_corporate_base/modules/pfizer_corporate_content/pfizer_corporate_press_release/js/press_release.min.js. */
!function(e){"use strict";Drupal.behaviors.press_release={attach:function(s,t){e(".view-full-list-of-press-release .views-row").each(function(){var s=(s=(s=e(this).html().replace("/*--&gt;*/","")).replace("/*--&gt;*/","")).replace("*/","");e(this).html(s)}),e(".toggle-press-release").once().click(function(){e(this).siblings(".archive-short-description").slideToggle(),e(this).toggleClass("open")})}}}(jQuery);
/* Source and licensing information for the above line(s) can be found at https://www.pfizer.com/modules/pfizer/pfizer_corporate_base/modules/pfizer_corporate_content/pfizer_corporate_press_release/js/press_release.min.js. */;
/* Source and licensing information for the line(s) below can be found at https://www.pfizer.com/modules/contrib/views_ajax_history/js/views_ajax_history.js. */
/**
 * @file
...
/* Source and licensing information for the above line(s) can be found at https://www.pfizer.com/modules/contrib/views_ajax_history/js/views_ajax_history.js. */;
...
/* Source and licensing information for the line(s) below can be found at https://www.pfizer.com/modules/contrib/better_exposed_filters/js/bef_select_all_none.js. */
/**
 * @file
...
/* Source and licensing information for the above line(s) can be found at https://www.pfizer.com/modules/contrib/better_exposed_filters/js/bef_select_all_none.js. */;
