/* Source and licensing information for the line(s) below can be found at https://www.pfizer.com/modules/pfizer/pfizer_corporate_base/modules/pfizer_corporate_content/pfizer_corporate_distributors/js/distributors.min.js. */
!function(t,e){e.behaviors.distributorsForm={attach:function(e,i){var o=location.href.split("/");t(window).on("load",function(){t("#edit-selected").length&&(t("#edit-selected option[value='"+o[o.length-1]+"']").length>=1?(t("#edit-selected").val(o[o.length-1]),t("#edit-selected option[val="+o[o.length-1]+"]").prop("selected",!0)):(t("#edit-selected").val("all"),t("#edit-selected option[val='all']").prop("selected",!0)))}),t("#edit-selected").change(function(){location.href=t(this).val()})}},e.behaviors.distributorTooltip={attach:function(e,i){setTimeout(function(){t(".view-auth-dist-pfizer a.distributor-link").each(function(){var e=t(this).closest("caption").find(".element-tooltip").html();t(this).attr("data-original-title",e).tooltip({placement:"right",trigger:"manual"})})},250),t("body").on("mouseenter",".view-auth-dist-pfizer a.distributor-link",function(){t(this).tooltip("show")}),t("body").on("mouseleave",".view-auth-dist-pfizer a.distributor-link",function(){var e=this;setTimeout(function(){t(".tooltip:hover").length||t(e).tooltip("hide")},500)}),t("a.distributor-link").on("click",function(t){t.preventDefault()})}}}(jQuery,Drupal);

/* Source and licensing information for the above line(s) can be found at https://www.pfizer.com/modules/pfizer/pfizer_corporate_base/modules/pfizer_corporate_content/pfizer_corporate_distributors/js/distributors.min.js. */;
/* Source and licensing information for the line(s) below can be found at https://www.pfizer.com/modules/pfizer/pfizer_corporate_base/modules/pfizer_corporate_content/pfizer_corporate_distributors/js/distributors.noderef.min.js. */
...
/* Source and licensing information for the above line(s) can be found at https://www.pfizer.com/modules/pfizer/pfizer_corporate_base/modules/pfizer_corporate_content/pfizer_corporate_distributors/js/distributors.noderef.min.js. */;
